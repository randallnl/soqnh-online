	...
	return (
		<Form className="panel post-editor-form" encType="multipart/form-data" method="post">
			...
			<div className="post-editor-grid">
				...
				{(isUpdate || section === "projects") && <label className="wide-field">Image <span>(optional)</span><input accept={imageUploadAccept} name="image" type="file" /><span className="field-help">PNG, JPG, WebP, or GIF. Maximum 10 MB.</span></label>}
