...
import { deleteContentImage } from "~/lib/media.server";
...
export async function loader({ request, context, params }: Route.LoaderArgs) {
	...
	return {
		...
		canArchiveProject: post.section === "project" && user.siteRole === "site_admin",
