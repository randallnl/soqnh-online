...
function messageFor(error: PostMutationError) {
	return {
		...
		"affiliation-required": "Choose at least one affiliation, or opt the posting organization in to the NH Connect public directory for statewide sharing.",
...
export function meta({ data }: Route.MetaArgs) {
	return [{ title: `New ${data?.definition.title ?? "post"} · NH Connect` }];
}
