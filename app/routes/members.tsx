...
export default function Members({ loaderData }: Route.ComponentProps) {
	...
	return <div className="member-directory-page">
		<section className="page-heading"><div><p className="eyebrow">Member directory</p><h1>People in the ecosystem</h1><p>Find collaborators, organizers, and community contacts across the member network.</p></div><Link className="button button--secondary heading-action" to="/profile"><Icon name="settings" size={17} /> Edit your profile</Link></section>
