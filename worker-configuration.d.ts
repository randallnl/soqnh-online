/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5f81ce1ebf86f9108fd0f592723fbc83)
...
interface __BaseEnv_Env {
	...
	EMAIL: SendEmail;
	APP_ENV: "production";
	APP_ORIGIN: "https://soqnh-online.randall-d53.workers.dev";
	EMAIL_FROM: "no-reply@nhsolidarityecosystem.com";
	SCRAPER_RUN_URL: "https://parter-event-scraper.randall-d53.workers.dev";
	SCRAPER_API_TOKEN: string;
	SCRAPER_ADMIN_TOKEN: string;
	EVENT_SCRAPER: Fetcher /* parter-event-scraper */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_ORIGIN" | "EMAIL_FROM" | "SCRAPER_RUN_URL" | "SCRAPER_API_TOKEN" | "SCRAPER_ADMIN_TOKEN">> {}
}
